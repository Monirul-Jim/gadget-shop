...
const EditProduct = () => {
    ...
    const handleAddedClasses = (event) => {
        ...
        fetch(`https://gadget-shop-server.vercel.app/seller-update-product/${_id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div className="bg-slate-300 add-product">
            <div className=' p-8  text-black mt-20 container mx-auto'>
                <p className=" text-2xl font-serif text-center mt-10 mb-16">--------- UPDATE A PRODUCT--------------</p>
                <form onSubmit={handleAddedClasses} className="container mx-auto" >
                    ...
                    <input type="submit" className='btn ml-[45%] mt-8' value="Update Product" />
                </form>
