...
const ProceedOrder = () => {
    ...
    useEffect(() => {
        const calculatedTotal = product.reduce((x, item) => {
            return x + (item?.initialPrice || 0);
        }, 0)
    ...
    const handleConfirmOrder = (event) => {
        ...
        const confirmOrderProduct = { name, last, email, number, division, district, area, post, address, feedback, total, products: product }
        fetch('https://gadget-shop-server.vercel.app/customer-double-quantity-order', {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(confirmOrderProduct)
            ...
            <form onSubmit={handleConfirmOrder} className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                <div>
                    ...
                    <div className="overflow-x-auto">
                        ...
                        <hr />
                        <div className='flex justify-end mt-2 mb-4'> <h1>Total: ${total}</h1> </div>
                    </div>
